/* Dll interface
 *
 *  Copyright (c) Alfred Reynolds,Botman 2000
 *  This file is covered by the GPL.
 *
 * $Id: h_export.cpp,v 1.18 2001/09/19 22:29:24 darope Exp $
 *
 */   
                ...
                float rad)
{
  ...
  if(ent==pTimerEnt) {
    ...
    DEBUG_LOG( 3, ("Returning next entity: %s\n", ent ? STRING(ent->v.classname) : "nil") );
#ifdef USE_METAMOD
...
*pGlobals ) {
  ...
  ptAM_botProtection = CVAR_GET_POINTER( "reserve_slots" );
