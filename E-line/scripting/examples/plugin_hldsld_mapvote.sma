 ...
 * ===========================================================================
 *
 * $Id: plugin_hldsld_mapvote.sma,v 1.3 2003/05/07 21:07:35 darope Exp $
 *
 *
...
public plugin_init() {
	plugin_registerinfo("Admin hlds_ld-style Map Vote Plugin","Runs a chat-based interface map vote, similar to hlds_ld.",AM_VERSION_STRING);
