 ...
 * ===========================================================================
 *
 * $Id: timer.cpp,v 1.5 2003/05/07 21:07:33 darope Exp $
 *
 *
...
void CTimer::CalcNextTimer() {
  ...
  if (m_iNextTimer == INVALID_TIMER) {
    ...
    DEBUG_LOG( 4, ("CTimer::CalcNextTimer: Next timer event found: #%i -- %s.",m_iNextTimer,timers[m_iNextTimer].sFunction) );
