...
// The _declspec forces them to be exported by name so we can do a lookup
// with GetProcAddress()
...
inline void MESSAGE_EGIN( int msg_dest, int msg_type, const float *pOrigin, entvars_t *ent ) {
...
//extern void			UTIL_ClientPrintAll( int msg_dest, constchar *msg_name, const char *param1 = NULL, const char *param2 = NULL, const char *param3 = NULL, const char *param4 = NULL );
