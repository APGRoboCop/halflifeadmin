/*
 * $Id: admin.sma,v 1.29 2001/09/27 20:33:16 darope Exp $
 *
 *
 ...
 * Comments:
 *
 * This is the monolithic Admin Mod script. It is only kept for legacy
 * support. Plugins should be preferred to keep scripting modular.
 *
