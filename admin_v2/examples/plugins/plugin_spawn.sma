/*
 * $Id: plugin_spawn.sma,v 1.3 2001/09/27 20:33:16 darope Exp $
 *
 *
 ...
 * Comments:
 *
 * This plugin contains commands for playing with spawn objects
 *
 */
...
public plugin_init() {
	plugin_registerinfo("Admin Spawn Plugin","Commands for spawning things.",STRING_VERSION);
