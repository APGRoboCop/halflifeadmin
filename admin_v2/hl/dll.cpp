/*
 * $Id: dll.cpp,v 1.37 2001/09/27 20:33:16 darope Exp $
 *
 *
...
const char vstring[] = "$Id: dll.cpp,v 1.37 2001/09/27 20:33:16 darope Exp $";
...
DLL_FUNCTIONS gFunctionTable = 
  {
    ...
    NULL,	// GetGameDescription,		//pfnGetGameDescription    Returns string describing current .dll game.
