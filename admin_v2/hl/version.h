/*
 * $Id: version.h,v 1.1 2001/09/27 20:33:16 darope Exp $
 *
 *
 ...
 * ===========================================================================
 *
 * Description: This file provides version information for Adminmod
 *
 */
...
#  ifdef USE_METAMOD
#    ifdef USE_MYSQL
#      define MOD_VERSION VERSION " (MM,mysql)"
#    else
#      define MOD_VERSION VERSION " (MM)"
#    endif
#  else
#    ifdef USE_MYSQL
#      define MOD_VERSION VERSION " (mysql)"
#    else
...
#define VNAME		"Adminmod"
#define VAUTHOR		"Alfred Reynolds <alfred@mazuma.net.au>"
