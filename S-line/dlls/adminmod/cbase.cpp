...
*
* $Id: cbase.cpp,v 1.1.1.2 2003/11/07 18:50:37 darope Exp $
*
 *
...
/*int CSaveRestoreBuffer::EntityIndex(EOFFSET eoLookup) // Required for newer HLSDK? [APG]RoboCop[CL]
{
...
CBaseEntity* CBaseEntity::Create(char* szName, const Vector& vecOrigin, const Vector& vecAngles, edict_t* pentOwner)
{
    ...
    /*		pCheckEntity = UTIL_FindEntityByClassname(NULL, szName);
                  ...
                  UTIL_LogPrintf("[ADMIN] spawn: The entity to be spawned was not cached at map load, so cannot be
       spawned.\n");
                  return 0;
                  }
    */
